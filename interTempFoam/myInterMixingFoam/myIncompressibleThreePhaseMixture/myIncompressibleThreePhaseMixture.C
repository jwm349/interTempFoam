...
void Foam::myIncompressibleThreePhaseMixture::calcNu()
{
    nuModel1_->correct();
    nuModel2_->correct();
    nuModel3_->correct();
...
Foam::myIncompressibleThreePhaseMixture::myIncompressibleThreePhaseMixture
(
...
//ADDED-------------------------->
	...
	Pr3_("Pr", dimensionSet(0, 0, 0, 0, 0, 0, 0), nuModel3_->viscosityProperties())
//<---------------------------ADDED
{
...
Foam::myIncompressibleThreePhaseMixture::mu() const
{
...
Foam::myIncompressibleThreePhaseMixture::muf() const
{
...
Foam::tmp<Foam::surfaceScalarField>
Foam::myIncompressibleThreePhaseMixture::nuf() const
{
    surfaceScalarField alpha1f(fvc::interpolate(alpha1_));
    surfaceScalarField alpha2f(fvc::interpolate(alpha2_));
    surfaceScalarField alpha3f(fvc::interpolate(alpha3_));
...
//ADDED---------------------------->
Foam::tmp<Foam::surfaceScalarField>
Foam::myIncompressibleThreePhaseMixture::kappaf() const
{
    surfaceScalarField alpha1f(fvc::interpolate(alpha1_));
    surfaceScalarField alpha2f(fvc::interpolate(alpha2_));
    surfaceScalarField alpha3f(fvc::interpolate(alpha3_));
...
bool Foam::myIncompressibleThreePhaseMixture::read()
{
