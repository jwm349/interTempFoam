...
const Foam::scalar Foam::myThreePhaseInterfaceProperties::convertToRad =
    Foam::constant::mathematical::pi/180.0;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::myThreePhaseInterfaceProperties::correctContactAngle
(
...
void Foam::myThreePhaseInterfaceProperties::calculateK()
{
...
Foam::myThreePhaseInterfaceProperties::myThreePhaseInterfaceProperties
(
    const myIncompressibleThreePhaseMixture& mixture
)
:
    mixture_(mixture),
    cAlpha_
...
Foam::myThreePhaseInterfaceProperties::surfaceTensionForce() const
{
...
Foam::myThreePhaseInterfaceProperties::nearInterface() const
{
    return max
    (
